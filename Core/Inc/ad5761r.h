...
#define AD5761R_CTRL_RA(x)		((x) & 0x7)	// RW
...
enum ad5761r_scale {
	AD5761R_SCALE_ZERO = 0,
	AD5761R_SCALE_HALF = 1,
	AD5761R_SCALE_FULL = 2,
};

enum ad5761r_range {
	AD5761R_RANGE_M_10V_TO_P_10V = 0,
	AD5761R_RANGE_0_V_TO_P_10V = 1,
	AD5761R_RANGE_M_5V_TO_P_5V = 2,
	AD5761R_RANGE_0V_TO_P_5V = 3,
	AD5761R_RANGE_M_2V5_TO_P_7V5 = 4,
	AD5761R_RANGE_M_3V_TO_P_3V = 5,
	AD5761R_RANGE_0V_TO_P_16V = 6,
	AD5761R_RANGE_0V_TO_P_20V = 7,
};
...
typedef struct {
  ...
  GPIO_TypeDef *ldac_port; uint16_t ldac_pin;  // optional (set NULL/0 if not used)
  GPIO_TypeDef *clr_port;  uint16_t clr_pin;   // optional
  GPIO_TypeDef *rst_port;  uint16_t rst_pin;   // optional
